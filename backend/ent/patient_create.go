...
func (pc *PatientCreate) SetStatusID(id int) *PatientCreate {
	pc.mutation.SetStatusID(id)
	return pc
}

// SetNillableStatusID sets the status edge to Status by id if the given value is not nil.
func (pc *PatientCreate) SetNillableStatusID(id *int) *PatientCreate {
	if id != nil {
...
func (pc *PatientCreate) SetStatus(s *Status) *PatientCreate {
